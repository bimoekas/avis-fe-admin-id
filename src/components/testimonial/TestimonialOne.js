          ...
          <div
            ...
            style={{
              backgroundImage:
                "url(" +
                publicUrl +
                "assets/images/backgrounds/testimonial-v1-bg.jpg)",
            }}
          ></div>
                  ...
                  <div className="testimonial-one__single">
                    ...
                    <div className="testimonial-one__single-top">
                      <div className="img-box">
                        <img
                          src={
                            publicUrl +
                            "assets/images/testimonial/testimonial-v1-img1.jpg"
                          }
                          alt=""
                        />
                      </div>
                    ...
                    <div className="testimonial-one__single-text">
                      <p>
                        ...
                        available, have suffered alteration in some form, by
                        injected humour, or which don't look even slightly
                        believable. If you are going to Ipsum, you need to be
                        sure there isn't embarrassing..{" "}
                      </p>
                    </div>
                    ...
                    <div className="testimonial-one__single-top">
                      <div className="img-box">
                        <img
                          src={
                            publicUrl +
                            "assets/images/testimonial/testimonial-v1-img2.jpg"
                          }
                          alt=""
                        />
                      </div>
